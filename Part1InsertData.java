...
public class Part1InsertData extends Configured implements Tool{
    ...
    public int run(String[] argv) throws IOException {
        ...
        try {
        	//Reading the text file and inserting the data
    		@SuppressWarnings("resource")
			BufferedReader br = new BufferedReader(new FileReader("amazon_reviews_us_Video_Games_v1_00.txt"));
    	    String line;
    	    ...
    	    while((line = br.readLine()) != null) {
    	    	...
    	    	String product_id = lineArray[3];
    	    	String product_parent = lineArray[4];
    	    	String product_title = lineArray[5];
    	    	String product_category = lineArray[6];
    ...
    public static void main(String[] argv) throws Exception {
        int ret = ToolRunner.run(new Part1InsertData(), argv);
        System.exit(ret);
    }
}